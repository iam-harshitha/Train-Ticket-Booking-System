    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            Using con As New SqlConnection("Data Source=LAPTOP-E1R3N0US\SQLEXPRESS;Initial Catalog=train;Integrated Security=True;Encrypt=True;Trust Server Certificate=True")
                ...
                Dim query As String = "INSERT INTO Payment (CardHolderName, CardNumber, ExpiryDate, PhoneNumber, TotalCost, CVV) VALUES (@CardHolderName, @CardNumber, @ExpiryDate, @PhoneNumber, @TotalCost, @CVV)"
            ...
            ' Close Form6 or navigate to the next form if needed
